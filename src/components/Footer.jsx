                    ...
                    <div className="space-y-3">
                        ...
                        <a href="tel:+251116670067" className="flex items-center gap-4 group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-sm font-bold text-white tracking-tight">+251 116 670 067 / +251 935 979 797</span>
                            </div>
                        </a>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-sm font-bold text-white tracking-tight">Gerji Mebrathaile Street</span>
                            </div>
                        </div>

                        {/* Website */}
                        <a
                            href="https://www.nexusaddis.net/"
                            target="_blank"
                        ...
                        >
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-sm font-bold text-white tracking-tight lowercase">nexusaddis.net</span>
                            </div>
                        </a>
                    </div>
                </div>
